...
Al observar el gráfico se puede observar que ha habido una separación de cada gen en el espacio de dos dimensiones. Teniendo en cuenta el cos2, que indica qué tan bien está representado un punto (muestra/individuo) o una variable en el plano o eje factorial que se está observando, los genes mejor representados (y que por lo tanto más relevancia tienen en las primeras dos dimensiones), son *POMC*, *ANO4*, *LEPR*, *ADCY3*, *PCDK1*, *NTRK*. Estos genes se pueden ver clusterizados en su mayoria en la parte derecha del gráfico.
