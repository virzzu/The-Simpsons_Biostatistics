...
fviz_pca_var(pca_facto,
             ...
             repel = TRUE)
```
Al observar el gráfico se puede observar que ha habido una separación de cada gen en el espacio de dos dimensiones. Teniendo en cuenta el cos2, que indica qué tan bien está representado un punto (muestra/individuo) o una variable en el plano o eje factorial que estás observando, los genes mejor representados (y qeue por lo tanto más relevancia tienen en las primeras dos dimensiones), son POMC, ANO4, LEPR, ADCY3, PCDK1, NTRK. Estos genes se pueden ver clusterizados en su mayoria en la parte derecha del gráfico.
...
```
Este gráfico es muy similar al anterior, pero en este se pueden observar tres distintos clústers, que agrupa genes según su relación.
---------------Yannis
...
```
Se pueden observar tres clústers de individuos basados en sus scores de PCA. El primer y segundo clúster estan solapados y no se separan bien, mientras que el tercer clúster está completamente separado. Esto puede indicar una similitud en el patrón de expresión de los dos primeros clústers, mientras que el tercero tendría un patrón distintivo a los otros dos.
